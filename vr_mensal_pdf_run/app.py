...
DEFAULT_COMPETENCIA = os.environ.get("VR_COMPETENCIA", "2025-05")  # YYYY-MM
...
def find_project_root():
    # Look for src/main.py near us or up to 3 parent levels
...
<body>
  <div class="card">
    ...
    <p class="hint">Se quiser mudar a competência: adicione parâmetros na URL, ex.: <code>/generate?inicio=2025-05-15&fim=2025-06-15&competencia=2025-06</code></p>
  </div>
</body>
</html>
"""
